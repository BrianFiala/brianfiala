...
export default function NavList({callBack}) {
  return (
    <List style={styles.list}>
      <ListItem component="li" button key="Home" onClick={callBack}>
        <Link style={styles.link} href="/">
          <ListItemIcon><HomeIcon color="primary" /></ListItemIcon>
          <ListItemText primary="Home" />
        </Link>
      </ListItem>
      <ListItem component="li" button key="Weather" onClick={callBack}>
        <Link style={styles.link} href="/weather">
          <ListItemIcon><WeatherIcon color="primary" /></ListItemIcon>
          <ListItemText primary="Weather" />
        </Link>
      </ListItem>
      <ListItem component="li" button key="Stocks" onClick={callBack}>
        <Link style={styles.link} href="/stocks">
          <ListItemIcon><StocksIcon color="primary" /></ListItemIcon>
          <ListItemText primary="Stocks" />
        </Link>
      </ListItem>
      <ListItem component="li" button key="Develop" onClick={callBack}>
